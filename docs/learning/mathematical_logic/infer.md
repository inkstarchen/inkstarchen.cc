...
![](./assets/Pasted%20image%2020250109154545.png)
...
![](./assets/Pasted%20image%2020250109154800.png)
...
![](./assets/Pasted%20image%2020250109155240.png)
...
=== "Picture"
    ![](./assets/Pasted%20image%2020250109155712.png){:align=left  width=400px}


## 因果推理
- **辛普森悖论**：在某个条件下的两组数据，分别讨论时都会满足某种趋势，可是一旦合并考虑，却可能导致相反的结论。（引入了混杂因素）
![](./assets/Pasted%20image%2020250109160349.png)
